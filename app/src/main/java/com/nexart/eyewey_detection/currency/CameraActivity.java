...
import com.nexart.eyewey_detection.currency.tflite.Classifier.Recognition;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void setFragment() {
    ...
    Fragment fragment;
    if (useCamera2API) {
      CameraConnectionFragmentt camera2Fragment =
              CameraConnectionFragmentt.newInstance(
                      new CameraConnectionFragmentt.ConnectionCallback() {
                        @Override
      ...
      fragment =
          new LegacyCameraConnectionFragment1(this, getLayoutId(), getDesiredPreviewFrameSize());
    }
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    ...
    if (results != null && results.size() >= 3) {
      ...
      Toast.makeText(this, "Result "+ results.get(0).getTitle(), Toast.LENGTH_SHORT).show();
      if (recognition != null) {
